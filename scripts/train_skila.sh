#!/bin/bash
export WANDB_PROJECT="LatentKnowledge-v1.1"
export WANDB_API_KEY="7b7525c91cfaddaff5f6"
...
# model configs
MODEL_SIZE='7B'
MODEL_NAME="/home/zlyuah/HDD/model/Qwen2.5-VL-7B-Instruct"
...
RANDOM_SEED=42
DATA_PATH="/home/zlyuah/HDD/data/Zebra-CoT/"
